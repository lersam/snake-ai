...
from ai import Linear_QNet, QTrainer, plot
...
class Agent:
    ...
    def __init__(self):
        ...
        self.model = Linear_QNet(input_size=11, output_size=3, hidden_size=256)
...
def train():
    ...
    if os.path.exists(model_path):
        try:
            # Load to CPU to avoid device mismatch issues; optimizer state is not saved in this project
